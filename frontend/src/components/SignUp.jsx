      ...
      <form>
        ...
        <div className="form-group mt-2 mb-2">
          ...
          <input
            ...
            ref = {password}
          />
          <button onClick={toggleVisibility1}>{show1 ? "Hide" : "Show"}</button>
          </div>
        </div>
        <div className="form-group mt-2 mb-2">
          ...
          <input
            ...
            ref = {confirmPassword}
          />
          <button onClick={toggleVisibility2}>{show2 ? "Hide" : "Show"}</button>
          </div>
        </div>
        <div className="form-group mt-2 mb-2">
          <label htmlFor="picture">Choose display picture</label>
          <input type="file" accept=".jpg,.jpeg,.png" className="form-control" id="picture" 
          ref={refPic}/>
        </div>
        <button type="submit" onClick={handleSubmit} className="btn btn-primary mt-3 w-100">
          Sign Up
        </button>
      </form>
    </div>
